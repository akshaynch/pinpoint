...
export class Backend implements backendInterface {
    ...
    async assignLocationToRider(arg0: bigint, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignLocationToRider(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async confirmPickup(arg0: bigint, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.confirmPickup(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllVerifications(): Promise<Array<Verification>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVerifications();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLocation(arg0: bigint): Promise<Location> {
        if (this.processError) {
            try {
    ...
    async getLocationAssignments(): Promise<Array<[bigint, Principal]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLocationAssignments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listVerifications(): Promise<Array<Verification>> {
        if (this.processError) {
            try {
                const result = await this.actor.listVerifications();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveLocation(arg0: string, arg1: number, arg2: number, arg3: string, arg4: string, arg5: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveLocation(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLocation(arg0: bigint, arg1: string, arg2: number, arg3: number, arg4: string, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLocation(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        appRole: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.appRole)),
        name: value.name
    };
}
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Customer" in value ? AppRole.Customer : "Rider" in value ? AppRole.Rider : value;
}
...
function to_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        appRole: value.appRole ? candid_some(to_candid_AppRole_n1(_uploadFile, _downloadFile, value.appRole)) : candid_none(),
        name: value.name
    };
}
